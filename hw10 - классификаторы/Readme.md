...
Так как в данном случае идет определение наличия болзени, для нас наибоее важным является показатель recall для положительных результатов, где все реальные положительные для класса 1 были правильно предсказаны. Однако для класса 0 эта метрика предсказала только 71% верно, но и выборка содержала всего 7 вхождений данного класса, это примерно 5 из 7 предсказаний класса 0 были верны.
